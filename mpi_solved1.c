...
* Bug: tag for sending and receiving doesn't match. Changed the TAG to MPI_ANY_TAG
in both receive commands. The other way of fixing this issue is to match the send-receive 
tags. 
******************************************************************************/
#include "mpi.h"
#include <stdio.h>
